...
private:
    ...
    convolution() : primitive_base() {} // Constructor necessary for serialization process
    CLDNN_SERIALIZATION_MEMBERS(
        ar & CLDNN_SERIALIZATION_BASE_OBJECT_NVP_PRIMITIVE_BASE(convolution) & CLDNN_SERIALIZATION_NVP(weights) & CLDNN_SERIALIZATION_NVP(bias) & CLDNN_SERIALIZATION_NVP(weights_quantization_factors) 
           & CLDNN_SERIALIZATION_NVP(output_calibration_factors) & CLDNN_SERIALIZATION_NVP(input_quantization_factor) & CLDNN_SERIALIZATION_NVP(output_quantization_factor) & CLDNN_SERIALIZATION_NVP(input_offset) 
           & CLDNN_SERIALIZATION_NVP(stride) & CLDNN_SERIALIZATION_NVP(dilation) & CLDNN_SERIALIZATION_NVP(with_activation) & CLDNN_SERIALIZATION_NVP(activation_negative_slope) & CLDNN_SERIALIZATION_NVP(with_output_size) 
           & CLDNN_SERIALIZATION_NVP(output_size) & CLDNN_SERIALIZATION_NVP(groups) & CLDNN_SERIALIZATION_NVP(padding_above) & CLDNN_SERIALIZATION_NVP(padding_below) & CLDNN_SERIALIZATION_NVP(_weights)
           & CLDNN_SERIALIZATION_NVP(_bias) & CLDNN_SERIALIZATION_NVP(_weights_quantization_factors) & CLDNN_SERIALIZATION_NVP(_output_calibration_factors);
        )
};
/// @}
/// @}
...
CLDNN_SERIALIZATION_EXPORT_NODE_KEY(convolution)
