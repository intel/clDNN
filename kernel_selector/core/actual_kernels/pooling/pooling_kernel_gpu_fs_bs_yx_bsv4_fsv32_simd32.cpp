...
//        k.EnablePoolType(PoolType::AVG);
    ...
    PoolingKernelBase::DispatchData PoolingKerneGPU_fs_bs_yx_bsv4_fsv32_simd32::SetDefault(const pooling_params& params) const
    {
    ...
    JitConstants PoolingKerneGPU_fs_bs_yx_bsv4_fsv32_simd32::GetJitConstants(const pooling_params& params, DispatchData kd) const
    {
    ...
    KernelsData PoolingKerneGPU_fs_bs_yx_bsv4_fsv32_simd32::GetKernelsData(const Params& params, const optional_params& options) const
    {
