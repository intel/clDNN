...
namespace kernel_selector {
    ...
    ConvolutionKernel_bfyx_f16::AutoTuneOption ConvolutionKernel_bfyx_f16::GetAutoTuneOptions(const Params&/* arg*/, int autoTuneIndex) const
    {
    ...
    ConvolutionKernelBase::DispatchData ConvolutionKernel_bfyx_f16::SetDefault(const convolution_params& params, int autoTuneIndex) const
    {
    ...
    JitConstants ConvolutionKernel_bfyx_f16::GetJitConstants(const convolution_params& params, const DispatchData& runInfo) const
    {
    ...
    KernelsData ConvolutionKernel_bfyx_f16::GetTunedKernelsDataByIndex(const Params& params, const optional_params& options, const int autoTuneIndex) const
    {
    ...
    KernelsData ConvolutionKernel_bfyx_f16::GetKernelsDataForAutoTune(const Params& params, const optional_params& options) const
    {
