...
namespace kernel_selector {
    ...
    ConvolutionKernel_bfyx_to_bfyx_f16::ConvolutionKernel_bfyx_to_bfyx_f16() : ConvolutionKernelBase("convolution_gpu_bfyx_to_bfyx_f16")
    {
    ...
    ConvolutionKernel_bfyx_to_bfyx_f16::AutoTuneOption ConvolutionKernel_bfyx_to_bfyx_f16::GetAutoTuneOptions(const Params&/* arg*/, int autoTuneIndex) const
    {
    ...
    ConvolutionKernelBase::DispatchData ConvolutionKernel_bfyx_to_bfyx_f16::SetDefault(const convolution_params& params, int autoTuneIndex) const
    {
    ...
    bool ConvolutionKernel_bfyx_to_bfyx_f16::Validate(const Params& p, const optional_params& o) const
    {
        ...
        // TODO Add support for output features not multiple of 16
        if (output.Feature().v % feature_block_size != 0)
            return false;

        // Check that padding before features doesn't miss-align the blocks
        if (input.Feature().pad.before % feature_block_size != 0 ||
            output.Feature().pad.before % feature_block_size != 0)
        {
            return false;
        }
    ...
    JitConstants ConvolutionKernel_bfyx_to_bfyx_f16::GetJitConstants(const convolution_params& params, const DispatchData& runInfo) const
    {
        ...
        size_t input_line_size = std::min(params.stride.x * (blockWidth  - 1) + params.weights.X().v, input.X().v + input.X().pad.Total());
    ...
    KernelsData ConvolutionKernel_bfyx_to_bfyx_f16::GetTunedKernelsDataByIndex(const Params& params, const optional_params& options, const int autoTuneIndex) const
    {
    ...
    KernelsData ConvolutionKernel_bfyx_to_bfyx_f16::GetKernelsData(const Params& params, const optional_params& options) const
    {
        return GetTunedKernelsDataByIndex(params, options);
    }

    KernelsData ConvolutionKernel_bfyx_to_bfyx_f16::GetKernelsDataForAutoTune(const Params& params, const optional_params& options) const
    {
