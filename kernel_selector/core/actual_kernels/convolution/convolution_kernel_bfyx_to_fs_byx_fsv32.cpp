...
namespace kernel_selector {
    ...
    ConvolutionKernel_bfyx_to_fs_byx_fsv32::ConvolutionKernel_bfyx_to_fs_byx_fsv32() : ConvolutionKernelBase("convolution_gpu_bfyx_to_fs_byx_fsv32")
    {
    ...
    ConvolutionKernel_bfyx_to_fs_byx_fsv32::AutoTuneOption ConvolutionKernel_bfyx_to_fs_byx_fsv32::GetAutoTuneOptions(const Params&, int autoTuneIndex) const
    {
    ...
    ConvolutionKernelBase::DispatchData ConvolutionKernel_bfyx_to_fs_byx_fsv32::SetDefault(const convolution_params& arg, int autoTuneIndex) const
    {
    ...
    JitConstants ConvolutionKernel_bfyx_to_fs_byx_fsv32::GetJitConstants(const convolution_params& params, const DispatchData& kd) const
    {
        ...
        auto inputBlockWidth = getInputSize(params.stride.x, params.filterSize.x, params.dilation.x, kd.cldnnStyle.blockWidth);
        auto inputBlockHeight = getInputSize(params.stride.y, params.filterSize.y, params.dilation.y, kd.cldnnStyle.blockHeight);
    ...
    KernelsData ConvolutionKernel_bfyx_to_fs_byx_fsv32::GetTunedKernelsDataByIndex(const Params& params, const optional_params& options, const int autoTuneIndex) const
    {
    ...
    KernelsData ConvolutionKernel_bfyx_to_fs_byx_fsv32::GetKernelsData(const Params& params, const optional_params& options) const
    {
        return GetTunedKernelsDataByIndex(params, options);
    }

    KernelsData ConvolutionKernel_bfyx_to_fs_byx_fsv32::GetKernelsDataForAutoTune(const Params& params, const optional_params& options) const
    {
