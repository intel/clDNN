...
namespace kernel_selector {
    ...
    ConvolutionKernel_fs_byx_fsv32::ConvolutionKernel_fs_byx_fsv32() : ConvolutionKernelBase("convolution_gpu_fs_byx_fsv32")
    {
    ...
    ConvolutionKernel_fs_byx_fsv32::AutoTuneOption ConvolutionKernel_fs_byx_fsv32::GetAutoTuneOptions(const Params& arg, int autoTuneIndex) const
    {
        ...
        for (auto w : optBlockWidths)
        {
            if (getMinRegisterUsage(cp, w) < regThreshold
                && Pad(cp.output.X().v, w) < minLeftover)
            {
    ...
    ConvolutionKernelBase::DispatchData ConvolutionKernel_fs_byx_fsv32::SetDefault(const convolution_params& arg, int autoTuneIndex) const
    {
    ...
    JitConstants ConvolutionKernel_fs_byx_fsv32::GetJitConstants(const convolution_params& params, const DispatchData& kd) const
    {
    ...
    KernelsData ConvolutionKernel_fs_byx_fsv32::GetTunedKernelsDataByIndex(const Params& params, const optional_params& options, const int autoTuneIndex) const
    {
    ...
    KernelsData ConvolutionKernel_fs_byx_fsv32::GetKernelsDataForAutoTune(const Params& params, const optional_params& options) const
    {
