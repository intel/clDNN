...
namespace kernel_selector {
    ...
    ConvolutionKernel_fs_byx_fsv32_1x1::ConvolutionKernel_fs_byx_fsv32_1x1() : ConvolutionKernelBase("convolution_gpu_fs_byx_fsv32_1x1")
    {
    ...
    ConvolutionKernel_fs_byx_fsv32_1x1::AutoTuneOption ConvolutionKernel_fs_byx_fsv32_1x1::GetAutoTuneOptions(const Params& arg, int autoTuneIndex) const
    {
    ...
    ConvolutionKernelBase::DispatchData ConvolutionKernel_fs_byx_fsv32_1x1::SetDefault(const convolution_params& arg, int autoTuneIndex) const
    {
    ...
    JitConstants ConvolutionKernel_fs_byx_fsv32_1x1::GetJitConstants(const convolution_params& params, const DispatchData& kd) const
    {
    ...
    KernelsData ConvolutionKernel_fs_byx_fsv32_1x1::GetTunedKernelsDataByIndex(const Params& params, const optional_params& options, const int autoTuneIndex) const
    {
    ...
    KernelsData ConvolutionKernel_fs_byx_fsv32_1x1::GetKernelsData(const Params& params, const optional_params& options) const
    {
        return GetTunedKernelsDataByIndex(params, options);
    }

    KernelsData ConvolutionKernel_fs_byx_fsv32_1x1::GetKernelsDataForAutoTune(const Params& params, const optional_params& options) const
    {
