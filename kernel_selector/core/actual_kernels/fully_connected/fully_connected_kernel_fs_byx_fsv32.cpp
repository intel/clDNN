...
namespace kernel_selector {
    ...
    std::unique_ptr<FullyConnected_fs_byx_fsv32::Parent::DispatchData> FullyConnected_fs_byx_fsv32::SetDefault(const fully_connected_params& params, int autoTuneIndex) const
    {
    ...
    KernelsData FullyConnected_fs_byx_fsv32::GetKernelsData(const Params& params, const optional_params& options) const
    {
        ...
        {
            KernelsData kd = GetTunedKernelsDataByIndex(params, options, DataLayout::fs_b_yx_fsv32, { WeightsLayout::os_iyx_osv32 }, FORCE_PRIORITY_5, (int)i);
            if (!kd.empty())
            {
