...
public:
    ...
    fused_conv_eltwise_kernel_imad()
        : fused_conv_eltwise_kernel_base("fused_conv_eltwise_gpu_imad")
    {}

    virtual ~fused_conv_eltwise_kernel_imad() {}

    virtual KernelsData GetKernelsData(const Params& params,
                                       const optional_params& options) const override;
    virtual ParamsKey GetSupportedKey() const override;

protected:
    bool Validate(const Params& params, const optional_params& options) const override;
    JitConstants GetJitConstants(const fused_conv_eltwise_params& params,
                                 const DispatchData& kd) const override;
    DispatchData SetDefault(const fused_conv_eltwise_params& arg,
