...
{
    class ActivationKernelRef : public CommonKernelBase
    {
        using DispatchData = CommonDispatchData;
    public:
        ActivationKernelRef() : CommonKernelBase("activation_ref") {}
    ...
    protected:
        ...
        DispatchData SetDefault(const ActivationParams& arg) const;
    };
}