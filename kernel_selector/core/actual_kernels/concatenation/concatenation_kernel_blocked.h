...
namespace kernel_selector {
    ...
    class ConcatenationKernelBlocked : public ConcatenationKernelBase
    {
    public:
        ConcatenationKernelBlocked() : ConcatenationKernelBase("concatenation_gpu_blocked") {}
        virtual ~ConcatenationKernelBlocked() {}
