...
kernel_selector::tile_axis convert_axis(tile::tile_axis axis)
{
    switch (axis)
    {
        case tile::along_x: return kernel_selector::tile_axis::X;
        case tile::along_y: return kernel_selector::tile_axis::Y;
        case tile::along_f: return kernel_selector::tile_axis::FEATURE;
        case tile::along_b: return kernel_selector::tile_axis::BATCH;
        default:
...
public:
    ...
    { 
        ...
        auto tile_optional_params = get_default_optional_params<kernel_selector::tile_optional_params>(arg.get_program());
...
CLDNN_SERIALIZATION_GPU_CLASS(tile)
