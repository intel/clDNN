...
#endif
{
    ...
    for(uint h = 0; h < INPUT_ELEMENTS_COUNT / 8; h++)
    {
        ...
        MAKE_VECTOR_TYPE(UNIT_TYPE, 8) blockB00 = ALIGNED_BLOCK_READ8(weight, weight_offset); weight_offset += 128;

        MULTIPLY_BLOCKS_16x8(blockC00, blockA00, blockB00)

        input_idx += 128; // 128 because of input format which have blocks of 128 elements
    }
